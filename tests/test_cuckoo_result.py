...
class TestCuckooResult:
            ...
            (
                {
                    "errors": [],
                    "log": [],
                    "cuckoo": ["blah Unable to execute the initial process, analysis aborted. blah"],
                },
                None,
                True,
            ),
    ...
    @staticmethod
    @pytest.mark.parametrize(
        "behaviour", [({"processes": []}), ({"processes": ["blah"], "apistats": {"blah": "blah"}})]
    )
                ...
                [
                    {
                        ...
                        "objectid": OntologyResults.create_objectid(
                            tag="blah", ontology_id="blah", service_name="Cuckoo"
                        ),
                    }
                ],
                False,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "creates_doc",
                [{"ioc": "~blahblahblahblahblah"}],
                "blahblahblahblahblah.txt",
            ...
            (
                "creates_hidden_file",
                [{"call": {"arguments": {"filepath": "blah.exe"}}}],
                "blah.txt",
                "blah.txt",
                True,
                False,
            ...
            (
                "creates_hidden_file",
                [{"call": {"arguments": {"filepath": "blah.txt"}}}],
                "blah.txt",
                "blah.txt",
                True,
                True,
            ...
            (
                "creates_hidden_file",
                [{"call": {"arguments": {"filepath": "desktop.ini"}}}],
                "blah.txt",
                "blah.txt",
                True,
                True,
            ...
            (
                "network_cnc_http",
                [{"suspicious_request": "benign http://w3.org", "type": "generic"}],
                "blah.txt",
                "blah.txt",
                True,
                True,
            ...
            (
                ...
                [{"host": "http://blah.com", "type": "generic"}],
                "blah.txt",
                "blah.txt",
                True,
                False,
            ...
            (
                "network_icmp",
                [{"ioc": "192.0.2.123", "type": "ioc", "category": "blah"}],
                "blah.txt",
                "blah.txt",
                True,
                False,
    ...
    def test_is_signature_a_false_positive(name, marks, filename, filename_remainder, nolookup_comms, expected_result):
        ...
        assert (
            _is_signature_a_false_positive(
                name, marks, filename, filename_remainder, inetsim_network, safelist, nolookup_comms
            )
            == expected_result
        )
    ...
    def test_extract_iocs_from_encrypted_buffers():
        ...
        _extract_iocs_from_encrypted_buffers(
            {
                1: {"network_calls": [{"send": {"buffer": "blah.com"}}]},
                2: {"network_calls": [{"send": {"buffer": "blah.ca"}}]},
            },
            test_parent_section,
            safelist,
        )
    ...
    def test_process_all_events():
        ...
        nc = default_so.create_network_connection(
            ...
            process=p,
            objectid=OntologyResults.create_objectid(
                tag="blah", ontology_id="blah", service_name="Cuckoo", time_observed="1970-01-01 00:00:02.000"
            ),
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    "1": {
                        "events": [{"command": {"original": "blah", "altered": "No alteration of event"}}],
                        "behaviors": ["blah"],
                    }
                },
                {0: {"blah": "blah"}},
    ...
    def test_process_hollowshunter():
        ...
        hollowshunter = {
            "123": {
                ...
                "scans": [{"workingset_scan": {"has_pe": 1, "module": "400000"}}],
            }
        }
        hollowshunter_body = [
            {"Process": "blah (123)", "Indicator": "Implanted PE", "Description": "Modules found: ['400000']"}
        ]
        ...
        [
                ...
                [
                    {
                        ...
                        "calls": [{"category": "network", "api": "getaddrinfo", "arguments": {"hostname": "blah"}}],
                        "pid": 1,
                    }
                ],
                {
            ...
            (
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [{"category": "network", "api": "GetAddrInfoW", "arguments": {"hostname": "blah"}}],
                        "pid": 1,
                    }
                ],
                {
                ...
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [
                            {"category": "network", "api": "connect", "arguments": {"ip_address": "blah", "port": 123}}
                        ],
                        "pid": 1,
                    }
                ],
            ...
            (
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [{"category": "network", "api": "send", "arguments": {"buffer": "blah"}}],
                        "pid": 1,
                    }
                ],
            ...
            (
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [{"category": "crypto", "api": "CryptDecrypt", "arguments": {"buffer": "blah"}}],
                        "pid": 1,
                    }
                ],
                {
            ...
            (
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [{"category": "system", "api": "OutputDebugStringA", "arguments": {"string": "blah"}}],
                        "pid": 1,
                    }
                ],
                {1: {"name": "blah.exe", "network_calls": [], "decrypted_buffers": []}},
                ...
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [
                            {"category": "system", "api": "OutputDebugStringA", "arguments": {"string": "cfg:blah"}}
                        ],
                        "pid": 1,
                    }
                ],
                ...
                [
                    {
                        "process_path": "blah.exe",
                        "calls": [
                            {"category": "network", "api": "URLDownloadToFileW", "arguments": {"url": "bad.evil"}}
                        ],
                        "pid": 1,
                    }
                ],
                        ...
                        "calls": [
                            {
                                "category": "network",
                                "api": "WSASend",
                                "arguments": {"buffer": "blahblahblah bad.evil blahblahblah"},
                            }
                        ],
                        "pid": 1,
                    }
