...
class TestCuckooResult:
    ...
    @pytest.mark.parametrize(
        ...
        [([{"pid": 0, "image": "blah", "command_line": "blah", "ppid": 1, "guid": "blah", "timestamp": 1.0, "pguid": "blah"}],
          False,
          '[{"pid": 0, "image": "blah", "timestamp": 1.0, "guid": "blah", "ppid": 1, "pguid": "blah", "command_line": "blah", "signatures": {}, "process_pid": 0, "process_name": "blah", "children": [], "node_hash": "8b7df143d91c716ecfa5fc1730022f6b421b05cedee8fd52b1fc65a96030ad52"}]'),
         ([{"pid": 0, "image": "blah", "command_line": "blah", "ppid": 1, "guid": "blah", "timestamp": 1.0, "pguid": "blah"}],
          True,
          '[{"pid": 0, "image": "blah", "timestamp": 1.0, "guid": "blah", "ppid": 1, "pguid": "blah", "command_line": "blah", "signatures": {}, "process_pid": 0, "process_name": "blah", "children": [], "node_hash": "8b7df143d91c716ecfa5fc1730022f6b421b05cedee8fd52b1fc65a96030ad52"}]'),
         ([],
         ...
         ([{"pid": 0, "image": "C:\\Users\\buddy\\AppData\\Local\\Temp\\blah.exe", "command_line": "blah", "ppid": 1, "guid": "blah", "timestamp": 1.0, "pguid": "blah"}],
          False,
          '[{"pid": 0, "image": "?usrtmp\\\\blah.exe", "timestamp": 1.0, "guid": "blah", "ppid": 1, "pguid": "blah", "command_line": "blah", "signatures": {}, "process_pid": 0, "process_name": "?usrtmp\\\\blah.exe", "children": [], "node_hash": "b39a28232192d3ac06b6195e383853f2ef24fa3b0e857d1a51eb12e4b338110d"}]'),
         ]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("", {"blah": "blah", "image": "got the image", "blah": "blahblah",
                ...
                {"blah": "blah", "image": "got the image", "blah": "blahblah", "node_hash": "b71bf6eacf36ecdf07b3f1efa5d6f50725271ca85369b966e19da5b76c175b5b",
    ...
    def test_remove_safe_leaves_helper(node, leaf_hashes, safe_leaf_hashes, expected_node):
        from cuckoo.cuckoo_result import _remove_safe_leaves_helper

        _remove_safe_leaves_helper(node, leaf_hashes, safe_leaf_hashes)
        assert node == expected_node
    ...
    def test_remove_safe_leaves(process_tree, leaf_hashes, safe_leaf_hashes, expected_process_tree):
        from cuckoo.cuckoo_result import _remove_safe_leaves

        _remove_safe_leaves(process_tree, leaf_hashes, safe_leaf_hashes)

        assert process_tree == expected_process_tree

    @staticmethod
    @pytest.mark.parametrize(
        "process_tree, safe_process_tree_hashes, safe_leaf_hashes, expected_process_tree",
        [
            ...
            {},
            {"63f4a4e5d1d649916ae2088bb28c3356b2348184c4dd332907e5498232da71ac": { "image": "?pf86\\microsoft office\\office14\\excel.exe", "node_hash": "e0e3b025c75e49d9306866f83a77c0356d825e25b1f4fc6ddbaf6339d3a22c62", "children": [ { "image": "?sys32\\wbem\\wmic1.exe", "node_hash": "444ba8aca3c500c14d6b9948e6564864ffe3533b17c8a7970b20ff4145884448", "children": [ { "image": "?sys32\\wbem\\wmic11.exe", "node_hash": "29ee5e07066a9f5c9f66856c8cadaf706439b1eaef79ddad74f3cac929b54464", "children": [ { "image": "?sys32\\wbem\\wmic111.exe", "node_hash": "63f4a4e5d1d649916ae2088bb28c3356b2348184c4dd332907e5498232da71ac", "children": [] } ] } ] } ] }, "6943c25c391d6dd1f87670f5135c621d3b30b05e211074225a92da65591ef38d": { "image": "?pf86\\microsoft office\\office14\\excel.exe", "node_hash": "e0e3b025c75e49d9306866f83a77c0356d825e25b1f4fc6ddbaf6339d3a22c62", "children": [ { "image": "?sys32\\wbem\\wmic1.exe", "node_hash": "444ba8aca3c500c14d6b9948e6564864ffe3533b17c8a7970b20ff4145884448", "children": [ { "image": "?sys32\\wbem\\wmic12.exe", "node_hash": "6943c25c391d6dd1f87670f5135c621d3b30b05e211074225a92da65591ef38d", "children": [] } ] } ] }, "a919e092d0d0149ce706c801290feabe3dc392d41283c9b575e6d1f0026bad1b": { "image": "?pf86\\microsoft office\\office14\\excel.exe", "node_hash": "e0e3b025c75e49d9306866f83a77c0356d825e25b1f4fc6ddbaf6339d3a22c62", "children": [ { "image": "?sys32\\wbem\\wmic2.exe", "node_hash": "a919e092d0d0149ce706c801290feabe3dc392d41283c9b575e6d1f0026bad1b", "children": [] } ] }, "6efb85adcc57520a6b6b72afaba81d82c5deae025761f98aa33125cb37274b40": { "image": "?pf86\\microsoft office\\office14\\excel.exe", "node_hash": "e0e3b025c75e49d9306866f83a77c0356d825e25b1f4fc6ddbaf6339d3a22c62", "children": [ { "image": "?sys32\\wbem\\wmic3.exe", "node_hash": "878e93a9cb19e3d8d659dbb3bd4945e53055f3b22c79ac49fac3070b3cc1acd7", "children": [ { "image": "?sys32\\wbem\\wmic31.exe", "node_hash": "6efb85adcc57520a6b6b72afaba81d82c5deae025761f98aa33125cb37274b40", "children": [] } ] } ] }, "099dc238ab64fb47b78557f727aa3a38a7c8b74c395c7010dd3bd2a63ec7ebdd": { "image": "?pf86\\microsoft office\\office14\\excel.exe", "node_hash": "e0e3b025c75e49d9306866f83a77c0356d825e25b1f4fc6ddbaf6339d3a22c62", "children": [ { "image": "?sys32\\wbem\\wmic3.exe", "node_hash": "878e93a9cb19e3d8d659dbb3bd4945e53055f3b22c79ac49fac3070b3cc1acd7", "children": [ { "image": "?sys32\\wbem\\wmic32.exe", "node_hash": "099dc238ab64fb47b78557f727aa3a38a7c8b74c395c7010dd3bd2a63ec7ebdd", "children": [] } ] } ] }, "4e99297d75424090c9b9c02fd62d19835e9ae15d3aa137ae3eab1b3c83088fa5": { "image": "?pf86\\microsoft office\\office14\\excel.exe", "node_hash": "e0e3b025c75e49d9306866f83a77c0356d825e25b1f4fc6ddbaf6339d3a22c62", "children": [ { "image": "?sys32\\wbem\\wmic3.exe", "node_hash": "878e93a9cb19e3d8d659dbb3bd4945e53055f3b22c79ac49fac3070b3cc1acd7", "children": [ { "image": "?sys32\\wbem\\wmic33.exe", "node_hash": "099dc238ab64fb47b78557f727aa3a38a7c8b74c395c7010dd3bd2a63ec7ebdd", "children": [] } ] } ] } },
            [])
        ]
    )
    def test_filter_process_tree_against_safe_hashes(process_tree, safe_process_tree_hashes, safe_leaf_hashes, expected_process_tree):
        from cuckoo.cuckoo_result import _filter_process_tree_against_safe_hashes
        task_id = 1
        assert _filter_process_tree_against_safe_hashes(process_tree, safe_process_tree_hashes, safe_leaf_hashes, task_id) == expected_process_tree
