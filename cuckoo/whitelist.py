...
WHITELIST_DOMAINS = {
    ...
    'Microsoft DNS Check': r'dms\.msftncsi\.com$',
    ...
    "Verisign": r".*\.verisign\.com$",
    "IPv6 Reverse DNS": r"[0-9a-f\.]+\.ip6.arpa$",
    "Azure DNS": r"\_ldap\._tcp\.dc\._msdcs\.(.*)$",
    'Azure Office': r"\_VLMCS\._TCP\.reddog\.microsoft\.com$",
    "Azure WPAD": r"wpad.*\.microsoft.com$",
    ...
    "Another Windows Updater": r"ctldl\.windowsupdate\.com",
    "Windows Settings": r"settings\-win\.data\.microsoft\.com",
    "Windows Cert": r"crl\.microsoft\.com",
